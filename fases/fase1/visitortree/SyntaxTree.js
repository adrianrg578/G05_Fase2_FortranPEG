...
export class Concat extends Node(){
     ...
     */
     primeraPos(){
        return this.c1.anulable() ? [...this.c1.primeraPos(), ...this.c2.primeraPos()] : this.c1.primeraPos();
    }
    /**
     *  @returns {number[]}
     */
    ultimaPos(){
        return this.c2.anulable() ? [...this.c1.ultimaPos(), ...this.c2.ultimaPos()] : this.c2.ultimaPos();
    }
    /** 
     *  @returns {boolean}
     */
